...
const student= mongoose.Schema({ //ye ek type type ka blueprint bn jaaega, jiska naam student rakh diya hai and usme data store krne k type mention kr diye hai
    name: String,
    class: String,
    roll_no : Number
})
